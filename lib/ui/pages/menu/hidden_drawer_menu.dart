    ...
    return SidebarX(
      ...
      items: [
        ...
        SidebarXItem(
          ...
          label: 'Profil',
          onTap: () {
            Application.router.navigateTo(context, Routes.profilePage, transition: TransitionType.fadeIn);
          }, 
        ),
        SidebarXItem(
          icon: Icons.message,
          label: 'Mesajlar',
          onTap: (){
            Application.router.navigateTo(context, Routes.chatPage, transition: TransitionType.fadeIn);
          },
        ),
        SidebarXItem(
          ...
          label: 'Bize Ulaşın',
          onTap: () {
            Application.router.navigateTo(context, Routes.contactPage, transition: TransitionType.fadeIn);
          },
        ),
        SidebarXItem(
          icon: Icons.logout,
